input_question =
    ...
    '  "patterns": {"90-100":"0","0-20":"1","20-90":"2"},\n' +
    '  "responses": ["What is your ","Could you tell me your "]\n' +
    '  },\n' +
    '  {"tag": "alcohol_useage",\n' +
   ...
   ' "instruction": "Size of tumor is measured in mm.",\n' +
    ...
    '  "patterns": {"t_tnm_stage 1":"0","t_tnm_stage 3":"1","t_tnm_stage 2":"2","t_tnm_stage 4":"3","t_tnm_stage X":"4","t_tnm_stage IS":"5","t_tnm_stage 0":"6","t_tnm_stage 1mic":"7"},\n' +
    '  "responses": ["What is your ","Could you tell me your "]\n' +
    '  },\n' +
    ...
    '  "patterns": {"n_tnm_stage 1":"0","n_tnm_stage 0":"1","n_tnm_stage 2":"2","n_tnm_stage X":"3","n_tnm_stage 3":"4"},\n' +
    '  "responses": ["What is your ","Could you tell me your "]\n' +
    '  },\n' +
    '  {"tag": "re_excision",\n' +
